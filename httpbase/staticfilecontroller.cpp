...
void StaticFileController::Handler(QHttpRequest& request, QHttpResponse& response)
{
    QByteArray path=request.path().toLocal8Bit();//request.getPath();
...
void StaticFileController::setContentType(QString fileName, QHttpResponse& response) const
{
