...
class StaticFileController : public QHttpHandler  {
    Q_OBJECT    
public:
    ...
    void Handler(QHttpRequest& request, QHttpResponse& response);
...
private:
    ...
    void setContentType(QString file, QHttpResponse& response) const;
};
