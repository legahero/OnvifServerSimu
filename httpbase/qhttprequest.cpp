...
QHttpRequest::QHttpRequest(QAsynHttpSocket *connection, QObject *parent)
...
{
    qDebug() << "QHttpRequest::~QHttpRequest";
}
...
{
    qDebug() << "QHttpRequest::appendBody "<<body;
    m_body.append(body);
}
